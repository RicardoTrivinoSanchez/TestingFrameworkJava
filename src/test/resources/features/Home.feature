...
#    Then the user has been directed to Cervantes page on Android
  ...
  @Mobile @iOS @App
  Scenario: Cervantes Flow
    Given a user with the Wikipedia app on iOS
    And the user is in the Home page on iOS
    When searching for 'Cervantes'
    Then the user has been directed to Cervantes page on iOS
